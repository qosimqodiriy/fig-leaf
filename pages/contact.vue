<template>
    <div class="py-40">
        <PageTitle text="КОНТАКТЫ" pageName="Контакт" />
        <div class="container">
            <div class="grid lg:grid-cols-3 gap-10 md:gap-16 py-40 lg:pt-60 xl:pt-80">
                ...
                <form @submit.prevent="submit" class="p-20 md:p-24 lg:p-28 xl:p-32 2xl:p-40 border border-gray-secondary">
                    <p class="text-24 md:text-26 lg:text-28 2xl:text-32 font-semibold mb-8">Если вам нужна информация <span class="text-green-primary">о нашей компании?</span></p>
                    <p class="text-18 font-interfaces mb-32">Заполните форму и мы обязательно свяжемся с вами</p>

                    <div class="pt-16 border-t border-gray-secondary space-y-16">
                        <input type="text" v-model="name" class="px-16 py-12 w-full outline-none border border-gray-secondary bg-white-secondary" placeholder="Имя" required>
                        <div class="flex items-center border border-gray-secondary bg-white-secondary">
                            <p class="py-12 pl-16">+998</p>
                            <input type="text" v-model="phone" id="phone" minlength="12" maxlength="12" class="w-full py-12 pl-10 outline-none border-none bg-white-secondary" placeholder="Номер телефона" required>
                        </div>
                        <textarea v-model="commit" class="w-full px-16 py-12 bg-white-secondary border border-gray-secondary outline-none" rows="6" placeholder="Сообщение"></textarea>
                        ...
                        <button type="submit" class="inline-flex cursor-pointer items-center bg-green-secondary rounded-2 gap-8 py-10 md:py-12 lg:py-14 xl:py-16 px-20 md:px-26 lg:px-32 xl:px-40">
                            <p class="text-14 font-semibold leading-130 uppercase">Отправить</p>
